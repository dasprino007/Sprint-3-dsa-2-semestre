...
void executar_cenarios(Sistema_t* sistema)
{
  ...
  adicionar_paciente(sistema, new_paciente("Carla", 31, false));
  adicionar_paciente(sistema, new_paciente("Diego", 29, false));
  adicionar_paciente(sistema, new_paciente("Elaine", 35, false));
  ...
  adicionar_paciente(sistema, new_paciente("Fernando", 68, true));
  adicionar_paciente(sistema, new_paciente("Gabriela", 27, false));
  adicionar_paciente(sistema, new_paciente("Henrique", 75, true));
  adicionar_paciente(sistema, new_paciente("Isabela", 33, false));
  adicionar_paciente(sistema, new_paciente("Joao", 80, true));
  ...
  printf("\n-------------------------------------------------\n");
  printf("HISTORICO APOS DESFAZER:\n");
  printf("-------------------------------------------------\n");
